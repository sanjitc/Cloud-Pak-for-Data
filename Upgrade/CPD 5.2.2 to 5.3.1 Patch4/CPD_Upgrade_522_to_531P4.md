...
```
## 3.7 Update WKC CR 
Remove the `wdp_profiling_flight_enabled` variable from the CR. Default value is `true`. Don't need this value to be set in WKC CR. You need to remove it from the `profiling-cr` also.
